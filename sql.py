...
def get_data (id_plante, c) : #  renvoie un sextuplet, id_plante est une Id valide (obtenu grace a la fonction id_plante())
...
def data_all (nom_plante, c) :# c est le curseur vers la base de donnee
...
def data_like (nom_plante, c) :# c est le curseur vers la base de donnee
  # nom_plante est une chaine de charactere qui designe le nom scientifique de la plante
  nom_plante = ("%"+nom_plante+"%",)
...
def id_plante (nom_plante, c) :# c est le curseur vers la base de donnee
  # nom_plante est une chaine de charactere qui designe le nom scientifique de la plante
  try :
    nom_plante = (nom_plante,)
    c.execute('SELECT * FROM base WHERE nom = ?',nom_plante)
